...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        OperationLogDao.createTable(db, ifNotExists);
        OrderDetailDao.createTable(db, ifNotExists);
        ProductsDao.createTable(db, ifNotExists);
        ProductsCategoryDao.createTable(db, ifNotExists);
        PurchaseDetailDao.createTable(db, ifNotExists);
        PurchaseSubtotalDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        OperationLogDao.dropTable(db, ifExists);
        OrderDetailDao.dropTable(db, ifExists);
        ProductsDao.dropTable(db, ifExists);
        ProductsCategoryDao.dropTable(db, ifExists);
        PurchaseDetailDao.dropTable(db, ifExists);
        PurchaseSubtotalDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(ProductsCategoryDao.class);
        registerDaoClass(PurchaseDetailDao.class);
        registerDaoClass(PurchaseSubtotalDao.class);
